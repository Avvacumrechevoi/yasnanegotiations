...
const PR={she:{id:'she',n:'Земля ШЭ',p:[0,4,8],c:'#A8762A',el:'Земля',
...
const T=[
  ...
  {id:'печи',verified:true,n:'Печи',rubrik:true,p:['Каналы подачи','Колосники','Объём топки','Огнеупорная пластина','Лабиринт','Камора','Труба','Догорел','Отапливаемый объем','Теплоупор','Кондиционер','Дверцы-заслонки']},
