...
const GLOSS=[
  ...
  {id:'support',title:'Опорный Крест (Крест Бытия)',color:'#E8364F',positions:'0 · 3 · 6 · 9',
   ...
   questions:['Если убрать это место — Ясна рассыпется?','Это одно из 4 самых важных состояний явления?','0 и 6 — антиподы по Линии Единства? 3 и 9 — антиподы по Линии Борьбы?'],
