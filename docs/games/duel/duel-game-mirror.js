...
(function(){
    ...
    return (
      <>
        ...
        <div className="duel-task" style={{textAlign:'center'}}>
          🧩 <strong>Расставь 12 меток</strong> Ясны «{yasna.n}» по своим местам. Кликни метку из пула, потом кликни нужное место.
        </div>
  ...
  window.YasnaDuels.register({
    ...
    description: 'Все 12 меток одной Ясны разбросаны в пуле. Расставь их по правильным местам. Очко за каждую правильную. При равенстве — кто быстрее.',
