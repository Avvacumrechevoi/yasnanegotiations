...
(function(){
  ...
  window.YasnaDuels.register({
    ...
    category: 'race',
    title: 'Опорный Крест',
    subtitle: 'Найди 4 опорных места быстрее',
    description: 'Кликни 4 места Опорного Креста (0/3/6/9). Без ошибок и быстрее соперника.',
    ...
    Component: makeRaceGame({
      target: [0, 3, 6, 9],
      hint: '🎯 Найди 4 места Опорного Креста: 0/3/6/9',
    }),
  });
  ...
  window.YasnaDuels.register({
    ...
    subtitle: 'Найди 4 места Управления',
    description: 'Кликни 4 места Креста Управления (1/4/7/10) — те, что СЛЕДУЮТ за опорными.',
    yasnaIds: ['суток', 'года', 'фаз_жизни'],
    defaultYasna: 'суток',
    difficulty: 2,
    estimatedSec: 35,
    Component: makeRaceGame({
      target: [1, 4, 7, 10],
      hint: '⚙️ Найди 4 места Креста Управления: 1/4/7/10',
    }),
  });
  ...
  window.YasnaDuels.register({
    ...
    category: 'race',
    title: 'Крест Веры',
    subtitle: 'Найди 4 места Веры',
    description: 'Кликни 4 места Креста Веры (2/5/8/11) — те, что ПРЕДШЕСТВУЮТ опорным.',
    yasnaIds: ['суток', 'года', 'фаз_жизни'],
    defaultYasna: 'суток',
    difficulty: 2,
    estimatedSec: 35,
    Component: makeRaceGame({
      target: [2, 5, 8, 11],
      hint: '🕊 Найди 4 места Креста Веры: 2/5/8/11',
    }),
  });
