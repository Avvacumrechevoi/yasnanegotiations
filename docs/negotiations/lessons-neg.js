  ...
  var LESSONS = [
    {
      ...
      outcome: 'Читать 4 типа людей и заходить верно', duration: '~6 мин',
      segments: [
        { type: 'intro', body: 'Прежде чем о чём-то договариваться — пойми, **кто** перед тобой. Люди по сути делятся на четыре типа, и к каждому нужен свой заход. Спутал тип — даже верный довод не сработает.' },
    ...
    },
    {
      ...
      outcome: 'Видеть дугу из 12 стадий и держать резонанс', duration: '~8 мин',
      segments: [
        { type: 'intro', body: 'Разговор — не хаос, а **дуга**: вход → нарастание → вершина → спад → итог. Видишь, на какой ты стадии, — понимаешь, какой ход делать.' },
        { type: 'widget', widget: 'arc', title: 'Дуга разговора', note: 'Пять фаз. Пройди по ним шаг за шагом.' },
        { type: 'widget', widget: 'stages', title: 'Все 12 стадий', note: 'Полная карта. Нажми любую стадию — раскроется разбор. Это справочник, к нему можно возвращаться.' },
    ...
    },
    {
      ...
      outcome: 'Строить честный обмен и не путать дело со статусом', duration: '~6 мин',
      segments: [
        { type: 'intro', body: 'Сделка держится на **обмене**: у каждого есть что взять и что дать. И на честности — перекос рождает последствия.' },
        ...
        { type: 'summary', body: 'Ты строишь честный обмен и видишь, где спор о деле, а где об уважении. Остался последний навык — **удержать контакт и красиво выйти**.' }
      ]
    },
    {
      id: 'l4', n: 4, title: 'Удержать и выйти',
      outcome: 'Чинить недопонимание и оставлять чистый след', duration: '~5 мин',
      segments: [
        { type: 'intro', body: 'После вершины разговор катится вниз — но по двум склонам: к **пониманию** или к **срыву**. И ещё: переговоры не кончаются на последнем слове — остаётся след.' },
