...
(function () {
  ...
  var CFG = {
    ...
    typeRole: { 'ХА': 'нетерпеливый руководитель', 'ФО': 'аналитик-скептик', 'ЦИ': 'человек смысла и тепла', 'ШЕ': 'практик до мозга костей' },
    typePrompt: {
