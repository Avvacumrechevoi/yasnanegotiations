...
const T=[
  ...
  {id:'переговоров',verified:true,starter:true,n:'Переговоров',rubrik:true,th:'Активная фаза (давление, конфликт, эмоции)',bh:'Тихая фаза (разведка, ритуал, накопление)',lh:'Нарастание ставок и давления',rh:'Спад через прорыв или закрытие',p:['Молчание / Слухи','Холодный Контакт','Зондирование','Открытие Позиции','Уточнения и Детали','Жёсткий Контр','Открытый Конфликт','Прорыв в Win-Win','Иллюзорный Консенсус','Срыв / Ультиматум','Точечная Атака','Закрытие / Ритуал']},
