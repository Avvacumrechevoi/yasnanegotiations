...
function App(){
  ...
  const PRESET_ATM_144 = {
    'Видимых атмосферных явлений|0': ['Соляная','Серебряная','Туманная','Утренняя','Травяная','Виноградная','Горная','Радужная','Каменная','Болотная','Лесная','Закатная'],
    'Видимых атмосферных явлений|1': ['Тонкий приземный','Кристаллический','Туманный','Радиационный','Полевой','Сахарный','Высотный','Лучевой','Каменный','Лесной','Ветровой','Цветочный'],
    'Видимых атмосферных явлений|2': ['Зернистая изморозь','Игольчатая','Лёгкая','Прозрачный гололёд','Налипающий снег','Чёрный лёд','Высотный обледенелый','Преломляющий','Каменный гололёд','Морской','Древесный','Электрический'],
    'Видимых атмосферных явлений|3': ['Морось','Грибной','Слепой','Утренний весенний','Ситный обложной','Ливневой','Грозовой','Радужный','Косой','Затяжной осенний','Ветровой','Ледяной'],
    'Видимых атмосферных явлений|4': ['Сухая пороша','Хлопья','Метель','Первый снег','Полевой','Лавинный','Высотный','Серебристый','Слежавшийся','Снегопад','Поземка','Алмазная пыль'],
    'Видимых атмосферных явлений|5': ['Снежная крупа','Ледяной горошек','Воздушный шарик','Весенний град','Полевой','Ливневой','Шквальный','Радиальный','Каменный','Тропический','Спиральный','Светящийся'],
    'Видимых атмосферных явлений|6': ['Тихая','Грибная','Шквальная','Утренняя','Затяжная фронтальная','Многоячеистая','Сильнейшая центральная','С радугой после','Горная каменная','Морская','Шаровая молния','Сухая'],
    'Видимых атмосферных явлений|7': ['Двойная','Молочная','Туманная','Утренняя восточная','Полевая','Брызговая','Высотная горная','Спектральная','Каменная','Морская','Лесная','Лунная'],
    'Видимых атмосферных явлений|8': ['Соляное гало','Цветной мираж','Туманный мираж','Утреннее гало','Полевой мираж','Ложное солнце','Высотное гало','Лучистое гало','Каменный мираж','Морской мираж','Лесное гало','Лунный нимб'],
    'Видимых атмосферных явлений|9': ['Затишье перед бурей','Ливневой шторм','Ветровой шквал','Шторм рождающийся','Полевая пыльная буря','Тропический ливень','Тропический ураган','Светящаяся буря','Каменная горная буря','Морской шторм','Воздушный циклон','Снежная буря'],
    'Видимых атмосферных явлений|10': ['Пыльный вихрь','Водяной смерч','Туманный смерч','Утренний','Полевой торнадо','Шквальная воронка','Высотный мезоциклон','Светящийся','Каменный горный шквал','Морской торнадо','Множественный','Огненный смерч'],
    'Видимых атмосферных явлений|11': ['Дугообразное','Корональное','Лучистое','Утреннее','Спокойное','Активное','Высотное яркое','Радужное','Огненное красное','Грозовое','Спиральное','Финальное'],
  };
