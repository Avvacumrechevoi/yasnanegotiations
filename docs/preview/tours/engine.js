      ...
      <div style={{position:'fixed',inset:0,background:BG,zIndex:200,display:'flex',flexDirection:'column',color:FG,fontFamily:'inherit',animation:'tourFadeIn .5s ease'}} onClick={e=>{ if(e.target===e.currentTarget) handleClose(); }}>
        ...
        <div style={{flex:1,display:'flex',minHeight:0,overflow:'hidden'}} className="tour-body">
          ...
          <div style={{flex:'2.2 1 0',display:'flex',alignItems:'center',justifyContent:'center',padding:'24px 18px',minWidth:0,position:'relative'}}>
            <div style={{position:'relative',width:'100%',maxWidth:1100,aspectRatio:'1040/780',background:SURFACE,borderRadius:18,border:'1px solid '+BORDER,overflow:'visible',transition:'all .8s cubic-bezier(.4,0,.2,1)',boxSizing:'border-box',display:'flex',alignItems:'center',justifyContent:'center'}}>
