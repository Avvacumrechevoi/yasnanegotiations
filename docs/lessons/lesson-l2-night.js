...
window.YasnaLessons.lessons.push(
  {
    ...
    blocks:[
      ...
      {type:'spiral-map',
        ...
        title:'Карта спирали',
        subtitle:'Курс идёт по спирали: каждый урок возвращается к знакомой структуре, только глубже.',
        learned:[0,3,6,9],
      ...
      {type:'toc',
        ...
        items:[
          ...
          'Сравним **три случая разных людей** — фрилансер, офисный работник, тимлид в IT.',
      ...
      {type:'checkbox-quiz',
        ...
        items:[
          ...
          {id:'cool-dark',label:'В спальне темно, прохладно и тихо',correct:true,
            feedbackOn:'Отлично. В таких условиях ядро работает в полную силу. Свет и шум сокращают глубокий и быстрый сон, даже если ты этого не замечаешь.',
          ...
          {id:'screen-bed',label:'Засыпаю с включённым экраном в руках или рядом',correct:false,
            ...
            feedbackOff:'Отлично — значит, эта помеха не про тебя.'},
          ...
          {id:'phone-first',label:'Проснулся — сразу открыл рабочие сообщения или почту',correct:false,
            ...
            feedbackOff:'Хорошо: утро остаётся твоим.'},
      ...
      {type:'checkbox-quiz',
        ...
        items:[
          ...
          {id:'v1-no',label:'Нет. Ядро есть, а рамок — ни до, ни после',correct:true,
            feedbackOn:'Да. Частый сбой у фрилансеров: часов сна вроде достаточно, но нет ни подготовки перед сном, ни мягкого утра. Мозг никогда не отдыхает полностью. Так и появляется это «высыпаюсь, а всё равно уставший».',
            feedbackOff:''}
        ]},
      {type:'scenario',
        variant:'Случай 2',
      ...
      {type:'checkbox-quiz',
        ...
        items:[
          {id:'v3-full',label:'Да, всё в порядке — 7 часов это нормально',correct:false,
            feedbackOn:'Ядро близко к норме, а вот рамок почти нет. YouTube перед сном — не подготовка, а просто другой экран. Рабочие чаты сразу после подъёма не дают мозгу переключиться. За несколько месяцев в таком режиме накапливается усталость и падает концентрация.',
            feedbackOff:''},
          {id:'v3-partial',label:'Частично. Ядро близко к норме, а рамок почти нет',correct:true,
            feedbackOn:'Точно. Частая история у людей с международным графиком. Что можно сделать: 20 минут без экрана перед сном и 15 минут утром без рабочих сообщений. Этого обычно хватает, чтобы рамки заработали.',
            feedbackOff:''},
      ...
      {type:'final-quiz-inline',
        ...
        questions:[
          ...
          {q:'Что случается, когда ты спишь 6 часов вместо 8?',
           ...
           correctIdx:1,
           explain:'Сокращение сна обрезает именно конец ночи — а там больше всего быстрого сна (REM). В этой фазе мозг закрепляет память и обрабатывает эмоции. Потому и «туман» — даже после формально нормального сна.'},
      ...
      {type:'summary-block',
        ...
        points:[
          ...
          'Когда спишь меньше, ты теряешь в основном быстрый сон — конец ночи. Там мозг обрабатывает память и эмоции — потому с утра и «туман».',
      ...
      {type:'spiral-map',
        ...
        subtitle:'Ты видишь ту же структуру из 12 частей, но у одной полочки раскрылось внутреннее устройство.',
        learned:[0,3,6,9],
        ...
        note:'**Важное наблюдение на этот виток:** у полочки есть ядро и рамки. Эта же логика — ядро и рамки — вернётся в следующем уроке. Только там она будет работать уже не для одной полочки, а для группы из трёх. Так и устроена спираль: одна идея растёт с каждым витком.'},
