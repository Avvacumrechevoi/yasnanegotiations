...
Обновлён: 2026-07-26 · ветка `main` · docs/preview УДАЛЁН (см. ниже).
...
docs/preview/                  ← УДАЛЁН 26.07.2026: живой дубль сайта на том же домене давал расхождения и двойную работу; старые ссылки /preview/* редиректит 404.html
```

**Принцип деплоя (с 26.07.2026):** правки идут сразу в `docs/`; CI собирает бандлы, гоняет Playwright-смоук и выкладывает Pages. Отдельного staging-дерева нет.
...
- ~~`docs/preview/` → `docs/`~~ — дерево preview удалено 26.07.2026, синхронизировать больше нечего.
